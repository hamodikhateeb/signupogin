...
public class ForgotPasswordFragment extends Fragment {
    ...
    public void onStart() {
        ...
        tvBack = getView().findViewById(R.id.tvBackToLoginForgotPassword);
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Task<Void> voidTask = fbs.getAuth().sendPasswordResetEmail(etEmail.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
